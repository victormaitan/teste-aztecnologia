<template>
  ...
  <div v-show="!isLoading" class="container">
    <FormNewCandidate v-show="!isLoading" @isLoading="(value) => (isLoading = value)" />
  </div>
</template>

<script>
import FormNewCandidate from '../components/FormNewCandidate.vue'
import Loading from '../components/LoadingSpinner.vue'

export default {
  components: { Loading, FormNewCandidate },
  data() {
    return {
      isLoading: false
    }
